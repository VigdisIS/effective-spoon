...
tittel = input("Tittel på møteagenda: ")
print("-------------------------------")
print("\n")
...
time.sleep(0.3)
inputContent.send_keys(f"📝_Referent_: **[Referent]**\n \
\n\
👁️_Til stede:_\n \
\n\
😴_Ikke til stede:_\n\
...
print(f"Success! Your new meeting agenda can be found at https://online.ntnu.no/wiki/komiteer/dotkom/administrativt/motereferater/{new_agenda}")
